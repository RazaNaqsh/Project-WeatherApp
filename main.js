...
async function getWeather() {
  ...
  try {
    ...
    _view__WEBPACK_IMPORTED_MODULE_0__["default"].showData(locationName, weatherMainData, weatherSubData);
  } catch (err) {
    console.log(err);
